...
_lr_productions = [
  ...
  ('prog -> func','prog',1,'p_program_single','PARSER_PLY.py',109),
  ('prog -> func prog','prog',2,'p_program_multiple','PARSER_PLY.py',115),
  ('func -> type var LPAREN flist RPAREN LBRACE body RBRACE','func',8,'p_function','PARSER_PLY.py',121),
  ('body -> stmt','body',1,'p_body_function','PARSER_PLY.py',129),
  ('body -> stmt body','body',2,'p_body_function','PARSER_PLY.py',130),
  ('stmt -> expr SEMI_COLON','stmt',2,'p_statement','PARSER_PLY.py',139),
  ('stmt -> defvar SEMI_COLON','stmt',2,'p_statement','PARSER_PLY.py',140),
  ('stmt -> IF LPAREN expr RPAREN stmt','stmt',5,'p_statement','PARSER_PLY.py',141),
  ('stmt -> IF LPAREN expr RPAREN stmt ELSE stmt','stmt',7,'p_statement','PARSER_PLY.py',142),
  ('stmt -> WHILE LPAREN expr RPAREN stmt','stmt',5,'p_statement','PARSER_PLY.py',143),
  ('stmt -> FOR LPAREN var IN expr RPAREN stmt','stmt',7,'p_statement','PARSER_PLY.py',144),
  ('stmt -> RETURN expr SEMI_COLON','stmt',3,'p_statement','PARSER_PLY.py',145),
  ('stmt -> LBRACE body RBRACE','stmt',3,'p_statement','PARSER_PLY.py',146),
  ('defvar -> type var','defvar',2,'p_define_variable','PARSER_PLY.py',171),
  ('expr -> var LPAREN clist RPAREN','expr',4,'p_define_expression','PARSER_PLY.py',182),
  ('expr -> expr LSQUAREBR expr RSQUAREBR','expr',4,'p_define_expression','PARSER_PLY.py',183),
  ('expr -> expr EQ expr','expr',3,'p_define_expression','PARSER_PLY.py',184),
  ('expr -> expr PLUS expr','expr',3,'p_define_expression','PARSER_PLY.py',185),
  ('expr -> expr MINUS expr','expr',3,'p_define_expression','PARSER_PLY.py',186),
  ('expr -> expr TIMES expr','expr',3,'p_define_expression','PARSER_PLY.py',187),
  ('expr -> expr DIVIDE expr','expr',3,'p_define_expression','PARSER_PLY.py',188),
  ('expr -> expr MOD expr','expr',3,'p_define_expression','PARSER_PLY.py',189),
  ('expr -> expr LESS_THAN expr','expr',3,'p_define_expression','PARSER_PLY.py',190),
  ('expr -> expr GREATER_THAN expr','expr',3,'p_define_expression','PARSER_PLY.py',191),
  ('expr -> expr PARITY expr','expr',3,'p_define_expression','PARSER_PLY.py',192),
  ('expr -> expr NOT_EQ expr','expr',3,'p_define_expression','PARSER_PLY.py',193),
  ('expr -> expr LESS_EQUAL expr','expr',3,'p_define_expression','PARSER_PLY.py',194),
  ('expr -> expr GREATER_EQUAL expr','expr',3,'p_define_expression','PARSER_PLY.py',195),
  ('expr -> expr OR expr','expr',3,'p_define_expression','PARSER_PLY.py',196),
  ('expr -> expr AND expr','expr',3,'p_define_expression','PARSER_PLY.py',197),
  ('expr -> NOT expr','expr',2,'p_define_expression','PARSER_PLY.py',198),
  ('expr -> MINUS expr','expr',2,'p_define_expression','PARSER_PLY.py',199),
  ('expr -> PLUS expr','expr',2,'p_define_expression','PARSER_PLY.py',200),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_define_expression','PARSER_PLY.py',201),
  ('expr -> var','expr',1,'p_define_expression','PARSER_PLY.py',202),
  ('expr -> num','expr',1,'p_define_expression','PARSER_PLY.py',203),
  ('flist -> type var','flist',2,'p_variable_multiple','PARSER_PLY.py',221),
  ('flist -> type var COMMA flist','flist',4,'p_variable_multiple','PARSER_PLY.py',222),
  ('flist -> <empty>','flist',0,'p_variable_multiple','PARSER_PLY.py',223),
  ('clist -> expr','clist',1,'p_variable_array','PARSER_PLY.py',241),
  ('clist -> expr COMMA clist','clist',3,'p_variable_array','PARSER_PLY.py',242),
  ('clist -> <empty>','clist',0,'p_variable_array','PARSER_PLY.py',243),
  ('type -> LIST_LABEL','type',1,'p_variabel_type','PARSER_PLY.py',256),
  ('type -> NUM_LABEL','type',1,'p_variabel_type','PARSER_PLY.py',257),
  ('num -> NUM','num',1,'p_expr_num','PARSER_PLY.py',264),
  ('var -> VAR','var',1,'p_expr_var','PARSER_PLY.py',271),
]
